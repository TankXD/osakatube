...
exports.watchVideos = exports.searchVideos = exports.registerView = exports.postUpload = exports.postEdit = exports.home = exports.getUpload = exports.getEdit = exports.deleteVideos = exports.deleteComment = exports.createComment = void 0;
...
exports.home = home;
var watchVideos = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            id = req.params.id; //const id = req.params.id와 같은방법. 하지만 ES6문법으로 쓰면 위에 방식이 된다.
            _context2.next = 3;
  ...
  return function watchVideos(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
exports.watchVideos = watchVideos;
...
var postUpload = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var _req$body2, title, description, hashtags, _id, _req$files, video, thumb, newVideo, user;
...
var deleteVideos = /*#__PURE__*/function () {
  ...
  return function deleteVideos(_x11, _x12) {
    return _ref6.apply(this, arguments);
  };
}();
exports.deleteVideos = deleteVideos;
var searchVideos = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            keyword = req.query.keyword; // req.query는 url에 있는 query부분 값을 추출해줌.
  ...
  return function searchVideos(_x13, _x14) {
...
var deleteComment = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    var id, commentId, comment, video;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 6:
            ...
            return _context10.abrupt("return", res.status(404).render("404", {

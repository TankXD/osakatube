...
var deleteCommentBtn = document.querySelectorAll(".video__comment-deleteBtn");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            commentId = comment.dataset.id; // console.log(commentId);
            _context.next = 4;
            return fetch("/api/videos/".concat(videoId, "/deleteComment"), {
              method: "DELETE",
              headers: {
...
var handleSubmit = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
    var textarea, text, response, json, newCommentId;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            text = textarea.value; // const videoId = videoContainer.dataset.id;
            if (!(text.trim() === "")) {
              _context2.next = 5;
              break;
            }
          ...
          case 12:
            json = _context2.sent;
            newCommentId = json.newCommentId;
